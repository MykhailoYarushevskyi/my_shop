...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage =
            'There was blocked all requests from this device due to unusual activity. Try again later';
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        errorMessage =
            'Could not find the user with that email. The user may have been deleted.';
  ...
  @override
  Widget build(BuildContext context) {
    print('## AuthScreen()->AuthCard().build()');
